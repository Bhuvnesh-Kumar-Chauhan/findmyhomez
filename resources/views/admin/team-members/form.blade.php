@php
    ...
    $socialLinks = isset($teamMember) ? $teamMember->social_links : [
        'facebook' => null,
        'twitter' => null,
        'linkedin' => null,
        'instagram' => null
    ...
    <div class="row mb-3">
        ...
        <div class="col-md-6">
            ...
            @if(isset($teamMember) && $teamMember->photo)
                <div class="mt-2">
                    <img src="{{ asset('storage/' . $teamMember->photo) }}" alt="{{ $teamMember->name }}" class="img-thumbnail" style="max-height: 100px;">
    ...
    <div class="row mb-3">
        <div class="col-md-12">
            ...
            <textarea class="form-control @error('bio') is-invalid @enderror" 
                      id="bio" name="bio" rows="3">{{ old('bio', $teamMember->bio ?? '') }}</textarea>
            @error('bio')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
