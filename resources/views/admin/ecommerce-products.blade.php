...
@endsection
@section('content')
    <x-breadcrub pagetitle="Morvin" subtitle="Ecommerce" title="Products"  />
                ...
                <div class="col-xl-3 col-lg-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="border p-3 rounded mt-4">
                                ...
                                <div id="accordion" class="custom-accordion categories-accordion">
                                    <div class="categories-group-card">
                                        <a href="#collapseOne" class="categories-group-list collapsed"
                                            ...
                                            <div>
                                                <ul class="list-unstyled categories-list mb-0">
                                                    <li class="active"><a href="#"><i
                                                                class="mdi mdi-circle-medium me-1"></i> Chairs </a></li>
                                                    <li><a href="#"><i class="mdi mdi-circle-medium me-1"></i>
                                                            Tables</a></li>
                                    ...
                                    <div class="categories-group-card">
                                        <a href="#collapseThree" class="categories-group-list collapsed"
                                            data-bs-toggle="collapse" aria-expanded="false" aria-controls="collapseThree">
                                            <i class="mdi mdi-pinwheel-outline font-size-16 align-middle me-2"></i> Baby &
                                            Kids
                                            <i class="mdi mdi-minus float-end accor-plus-icon"></i>
                                        </a>
                                    ...
                                    <div class="categories-group-card">
                                        <a href="#collapseFour" class="categories-group-list collapsed"
                            ...
                            <div class="border p-3 rounded mt-4">
                                <h5 class="font-size-16 mb-0 custom-accordion"><a href="#collapseExample1"
                                        class="text-dark d-block" data-bs-toggle="collapse">Discount <i
                                            class="mdi mdi-minus float-end accor-plus-icon"></i></a></h5>

                                <div class="collapse show" id="collapseExample1">

                                    <div class="mt-4">
                                        <div class="form-check mt-2">
                                            <input type="radio" id="productdiscountRadio6" name="productdiscountRadio1"
                                                class="form-check-input">
                                            <label class="custom-control-label" for="productdiscountRadio6">50% or
                                                more</label>
                                        </div>
                                        <div class="form-check mt-2">
                                            <input type="radio" id="productdiscountRadio5" name="productdiscountRadio1"
                                                class="form-check-input">
                                            <label class="custom-control-label" for="productdiscountRadio5">40% or
                                                more</label>
                                        </div>
                                        <div class="form-check mt-2">
                                            <input type="radio" id="productdiscountRadio4" name="productdiscountRadio1"
                                                class="form-check-input">
                                            <label class="custom-control-label" for="productdiscountRadio4">30% or
                                                more</label>
                                        </div>
                                        <div class="form-check mt-2">
                                            <input type="radio" id="productdiscountRadio3" name="productdiscountRadio1"
                                                class="form-check-input">
                                            <label class="custom-control-label" for="productdiscountRadio3">25% or
                                                more</label>
                                        </div>
                                        <div class="form-check mt-2">
                                            <input type="radio" id="productdiscountRadio2" name="productdiscountRadio1"
                                                class="form-check-input">
                                            <label class="custom-control-label" for="productdiscountRadio2">10% or
                                                more</label>
                                        </div>
                                        <div class="form-check mt-2">
                                            <input type="radio" id="productdiscountRadio1" name="productdiscountRadio1"
                                                class="form-check-input">
                                            <label class="custom-control-label" for="productdiscountRadio1">Less than
                                                10%</label>
                                        </div>
                                    </div>
                            ...
                            <div class="border p-3 rounded mt-4">
                                <h5 class="font-size-16 mb-0 custom-accordion"><a href="#collapseExample3"
                                ...
                                <div class="collapse show" id="collapseExample3">
                                    ...
                                    <div class="mt-4">
                                        <div class="form-check mt-2">
                                            <input type="radio" id="productratingRadio5" name="productratingRadio1"
                                                class="form-check-input">
                                            <label class="custom-control-label" for="productratingRadio5">5 <i
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <h4 class="mt-3 mb-0">$200 <span
                                                class="font-size-14 text-muted me-2"><del>$240</del></span></h4>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="product-img">
                                        ...
                                        <img src="{{ URL::asset('build/images/product/img-8.png') }}" alt=""
                                            class="img-fluid mx-auto d-block">
                                    </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="product-img">
                                        ...
                                        <img src="{{ URL::asset('build/images/product/img-9.png') }}" alt=""
                                            class="img-fluid mx-auto d-block">
                                    </div>
                                    ...
                                    <div class="text-center">
                                        ...
                                        <h4 class="mt-3 mb-0">$380 <span
                                                class="font-size-14 text-muted me-2"><del>$420</del></span></h4>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="product-img">
                                        ...
                                        <img src="{{ URL::asset('build/images/product/img-11.png') }}" alt=""
                                            class="img-fluid mx-auto d-block">
                                    </div>
                                    ...
                                    <div class="text-center">
                                        ...
                                        <h4 class="mt-3 mb-0">$280 <span
                                                class="font-size-14 text-muted me-2"><del>$320</del></span></h4>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="product-img">
                                        ...
                                        <img src="{{ URL::asset('build/images/product/img-14.png') }}" alt=""
                                            class="img-fluid mx-auto d-block">
                                    </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div>
                                                <p class="mb-sm-0 mt-2">Page <span class="font-weight-bold">2</span> Of
                                                    <span class="font-weight-bold">113</span></p>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
