                                    ...
                                    <div class="dash-info-widget mt-4 mt-lg-0 py-4 px-3 rounded">
                                        ...
                                        <div class="media mt-4 dash-main-border pb-2">
                                            ...
                                            <div class="media-body ps-3">
                                                ...
                                                <p class="text-muted">To Paid <a href="#" class="text-primary">Pay
                                        ...
                                        <div class="media-body">
                                            <div class="text-end d-none d-md-block">
                                                <p class="text-muted font-size-13 mt-2 pt-1 mb-0"><i
                                                        class="mdi mdi-timer-outline font-size-15 text-primary"></i> 3
                                                    days</p>
                                            </div>
                                        </div>
                                ...
                                <li class="activity-list activity-border">
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <div class="text-end d-none d-md-block">
                                                <p class="text-muted font-size-13 mt-2 pt-1 mb-0"><i
                                                        class="mdi mdi-timer-outline font-size-15 text-primary"></i> 1
                                                    days</p>
                                            </div>
                                        </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-centered table-nowrap mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>#2356</td>
                                            <td><img src="{{ URL::asset('build/images/product/img-7.png') }}"
                                                    width="42" class="me-3" alt="">Green Chair</td>
                                        ...
                                        <tr>
                                            <td>#2564</td>
                                            <td><img src="{{ URL::asset('build/images/product/img-8.png') }}"
                                                    width="42" class="me-3" alt="">Office Chair</td>
                                            <td>Alfred Gordon</td>
                                            <td>$242.00</td>
                                            <td>54</td>
                                            <td><span
                                        ...
                                        <tr>
                                            <td>#2125</td>
                                            <td><img src="{{ URL::asset('build/images/product/img-10.png') }}"
                                                    width="42" class="me-3" alt="">Gray Chair</td>
                                            <td>Keena Reyes</td>
                                            <td>$320.00</td>
                                            <td>65</td>
                                            <td><span
                                        ...
                                        <tr>
                                            <td>#8587</td>
                                            <td><img src="{{ URL::asset('build/images/product/img-11.png') }}"
                                                    width="42" class="me-3" alt="">Steel Chair</td>
                                        ...
                                        <tr>
                                            <td>#2354</td>
                                            <td><img src="{{ URL::asset('build/images/product/img-12.png') }}"
                                                    width="42" class="me-3" alt="">Home Chair</td>
                                            <td>Joann Wiliams</td>
                                            <td>$320.00</td>
                                            <td>25</td>
                                            <td><span
