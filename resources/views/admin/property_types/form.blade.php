    ...
    <div class="row mb-3">
        <div class="col-md-12">
            ...
            <textarea class="form-control @error('description') is-invalid @enderror" 
                      id="description" name="description" rows="3">{{ old('description', $propertyType->description ?? '') }}</textarea>
            @error('description')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
    ...
    <div class="row mb-3">
        <div class="col-md-6">
            ...
            @if(isset($propertyType) && $propertyType->image)
                <div class="mt-2">
                    <img src="{{ asset('storage/' . $propertyType->image) }}" alt="{{ $propertyType->name }}" class="img-thumbnail" style="max-height: 100px;">
