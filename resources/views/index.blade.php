    ...
    <section class="blog">
        <div class="container">
            ...
            <ul class="row">
                ...
                <!--======= BLOG 1 =========-->
                <li class="col-sm-4">
                    <div class="b-inner"> <img class="img-responsive" src="images/blog-img-1.jpg" alt="">
                        <div class="b-details">
                            <div class="post-admin"> <img src="images/auther-1.jpg" alt="">
                                <h6>By Mike</h6>
                                <span class="pull-right"><i class="fa fa-comment-o"></i> 6 </span> <span
                                    class="pull-right"><i class="fa fa-heart-o"></i> 10 &nbsp; &nbsp;| &nbsp;&nbsp;</span>
                            </div>
                            <div class="bottom-sec"> <span><i class="fa fa-calendar"></i> mar 23 ,2015</span> <a
                                    class="font-montserrat" href="#.">Sweet home for your sweet family</a>
                                <hr>
                                <p>We've been waiting for you. Where the kisses are hers and hers and his. </p>
                            </div>
                        </div>
                    </div>
                </li>
                ...
                <!--======= BLOG 2 =========-->
                <li class="col-sm-4">
                    <div class="b-inner"> <img class="img-responsive" src="images/blog-img-2.jpg" alt="">
                        <div class="b-details">
                            <div class="post-admin"> <img src="images/auther-1.jpg" alt="">
                                <h6>By Mike</h6>
                                <span class="pull-right"><i class="fa fa-comment-o"></i> 6 </span> <span
                ...
                <!--======= BLOG 3 =========-->
                <li class="col-sm-4">
                    <div class="b-inner"> <img class="img-responsive" src="images/blog-img-3.jpg" alt="">
                        <div class="b-details">
                            <div class="post-admin"> <img src="images/auther-1.jpg" alt="">
                                <h6>By Mike</h6>
                                <span class="pull-right"><i class="fa fa-comment-o"></i> 6 </span> <span
